...
export const SETTINGS_REGISTRY: Record<string, SettingDefinition> = {
  ...
  trash_folder: {
    ...
    label: 'Trash Folder',
    scope: SETTING_SCOPES.ACCOUNT,
    remotePath: ['mail', 'trash_folder'],
    localKey: (account) => `trash_folder_${account}`,
    valueType: 'string',
    defaultValue: '',
    accountScoped: true,
    localFallbackOnDefault: true,
  ...
  junk_folder: {
    ...
    label: 'Junk Folder',
    scope: SETTING_SCOPES.ACCOUNT,
    remotePath: ['mail', 'junk_folder'],
    localKey: (account) => `junk_folder_${account}`,
    valueType: 'string',
    defaultValue: '',
    accountScoped: true,
    localFallbackOnDefault: true,
